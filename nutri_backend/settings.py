"""
Django settings for nutri_backend project.
Supports both local development (.env) and Railway production (env vars).
"""
...
# Railway injects RAILWAY_STATIC_URL — add it to allowed hosts automatically
...
ROOT_URLCONF = 'nutri_backend.urls'
...
WSGI_APPLICATION = 'nutri_backend.wsgi.application'
...
# ── Media files (user uploads / photos) ───────────────────────────────────────
MEDIA_URL  = '/media/'
